...
I am 25 years old and I am passionate about computing in the broad sense:
dev, web technos, hardware, Linux, IoT,...
...
I am currently working in [Pepperbay](https://www.pepperbay.fr/), a web development agency, after a work-study program accomplished in this company.

## Professional experience

**Pepperbay - Web Developer**: 2019 - 2021
...
- Internationalization management: ~~[i18next](https://www.i18next.com/)~~ Lighter custom solution
...
Training leading to a level 1 RNCP qualification (Bac+5) "Expert in Computer Science and Information Systems", and carried out in an apprenticeship in the [Fleury Michon](https://www.fleurymichon.fr/) company and [Pepperbay](https://www.pepperbay.fr/).
